const Strings = {
  ...
  GOMAPS_API_KEY: 'AIzaSyBkCIKQZ1ydCbRHBrXmC8hUh2dsrnCDEWI', // Sagar Sadamate
  ...
  PHOTO_SHOW:'https://maps.googleapis.com/maps/api/place/photo?maxwidth=400&photoreference=',
